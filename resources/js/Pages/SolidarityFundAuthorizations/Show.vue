...
<template>
    <Head title="Machtiging Solidariteitsfonds Details" />

    <AuthenticatedLayout>
        <template #header>
            <PageHeader 
                title="Machtiging Solidariteitsfonds Details"
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="mb-6">
                    <Link :href="route('solidarity-fund-authorizations.index')"
                    ...
                    <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                            ...
                            <ul class="text-sm text-blue-800 dark:text-blue-200 space-y-1 list-disc list-inside">
                                <li>De incasso vindt jaarlijks plaats in november.</li>
                                <li>Het bedrag bedraagt momenteel €27,50 per persoon voor alle leden van 18 jaar en ouder.</li>
