                ...
                <div v-if="!props.hasZaaier"
                    ...
                    <div class="p-6">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Abonnement De
                                    Zaaier</h3>
                                <p class="text-gray-600 dark:text-gray-300 mb-4">
                                    U heeft nog geen machtiging voor De Zaaier afgegeven. Wilt u toch de Zaaier
                                    ontvangen en/of
                                    een machtiging afgeven? Geef dit dan eenvoudig door via het formulier hieronder.
                                </p>
                ...
                <div v-if="!props.hasSolidarityFund"
                    ...
                    <div class="p-6">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Solidariteitsfonds
                                </h3>
                                <p class="text-gray-600 dark:text-gray-300 mb-4">
                                    U heeft nog geen machtiging voor het Solidariteitsfonds afgegeven. Wilt u toch een
                                    machtiging afgeven? Geef dit dan eenvoudig door via het formulier hieronder.
                                </p>
                                <Link :href="route('solidarity-fund-authorizations.create')"
                                    class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                                    Machtiging afgeven
                                    <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">Vrijwillige
                                    Bijdrage 2026
                                </h3>
                                <p class="text-gray-600 dark:text-gray-300 mb-4">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-600 dark:text-gray-300 mb-4">
                                    Heeft u vragen of opmerkingen? Stel ze gerust via het contact formulier of mail naar
                                    <a href="mailto:hhhazelhorst@hhgrijssen.nl"
                                        class="text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">hhhazelhorst@hhgrijssen.nl</a>.
                                </p>
                                <Link :href="'/contact'"
                                    class="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
