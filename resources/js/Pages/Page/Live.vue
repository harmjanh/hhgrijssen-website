    ...
    <div class="mx-auto max-w-7xl px-3 py-12 md:px-6 lg:px-8">
        ...
        <div class="bg-gray-50 rounded-xl p-8">
            ...
            <div class="prose max-w-none text-left text-gray-700 text-xl/8">
                ...
                <p>
                    1) <a href="https://link.socie.nl/r/sci/c/553EM4YZ4T" target="_blank">Via het online
                        collecteformulier.</a>
                    <br />
        ...
        <div class="text-center">
            <a href="https://link.socie.nl/r/sci/c/553EM4YZ4T" target="_blank"
                class="inline-flex items-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors ">
                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    <path
                        d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
                Klik hier voor het collecteformulier via Scipio
            </a>
        </div>
    </div>
